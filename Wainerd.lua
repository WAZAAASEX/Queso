...
task.spawn(
    function()
        ...
        local win = discord:Window("Wyvern 1.4 - redblues edition [Ride The Wave]")
        ...
        local inputlink = loadstring(game:HttpGet("https://raw.githubusercontent.com/WAZAAASEX/Queso/main/C"))()
