...
task.spawn(
    function()
        local discord = loadstring(game:HttpGet("https://github.com/WAZAAASEX/Queso/raw/main/DiscordLib.lua"))()
        local win =
            discord:Window("Wyvern " .. getgenv().wyvern_version .. " - redblues edition [DylanElHacker = Femboy]")
        local serv = win:Server("Wyvern", "y")
        ...
        if getgenv().WyvernConfig["UGC Limiteds"] then
            ...
            local inputlink = loadstring(game:HttpGet("https://raw.githubusercontent.com/WAZAAASEX/Queso/refs/heads/main/cl.lua"))()
                ...
                function(x)
                    ...
                    if index then
                        ...
                        elseif chosenversionsubplace == "Copy Game Link" then
                            setclipboard(
                                "-- This Script was Generated by Wyvern Script\n https://www.roblox.com/games/" ..
                                    tostring(PlaceId)
                            )
                        end
                    else
        ...
        task.spawn(
            function()
                getgenv().realwyvernversion = loadstring(game:HttpGet("https://raw.githubusercontent.com/WAZAAASEX/Queso/refs/heads/main/ver.lua"))()
                ...
                if getgenv().wyvern_version == nil or getgenv().wyvern_version ~= getgenv().realwyvernversion then
                    if getgenv().SentPromptCorePackage == false then
                        ...
                        local PromptLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/WAZAAASEX/Queso/refs/heads/main/pm.lua"))()
                        PromptLib(
                            "Heads Up!",
